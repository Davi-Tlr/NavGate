...
O app usa SQLite local (`expo-sqlite`) para persistir os favoritos do usuário. A escolha foi feita pensando em uso offline em campo — um piloto em voo não tem garantia de conexão.
